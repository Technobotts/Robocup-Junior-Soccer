...
public class LineLeader extends I2CSensor
{
	 ...
	 *            <tr>
	 *            <th>R</th>
	 *            <td>Reset Color inversion (black line on a white background,
	 *            this is also the default).</td>
	 *            </tr>
	 *            <tr>
	 *            <th>S</th>
	 *            <td>Take a snapshot, this command looks at the line under the
	 *            sensor and stores the width and position of the line in
	 *            sensor’s memory. Subsequently, sensor will use these
	 *            characteristics of line to track it. This command inverts the
	 *            colors if it sees a white line on a black background. (PID
	 *            parameters are not affected).</td>
	 *            </tr>
	 *            <tr>
	 *            <th>A</th>
	 *            <td>Configure Sensor for US region (and regions with 60Hz
	 *            electrical frequency).</td>
	 *            </tr>
	 *            <tr>
	 *            <th>E</th>
	 *            <td>Configure sensor for European regions (and regions with
	 *            50Hz electrical frequency).</td>
	 *            </tr>
	 *            <tr>
	 *            <th>U</th>
	 *            <td>Configure sensor for universal frequency (in this mode the
	 *            sensor adjusts for any frequency). This is the default mode.</td>
	 *            </tr>
	 *            </table>
